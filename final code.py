...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        flag = 0
        # configure window
        self.title("Face Detection using Deep Learning")
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Face Detector",
        ...
        self.graph1_button = customtkinter.CTkButton(self.tabview.tab("Confidence"), text=" ", width=350, height=250,
    ...
    def det_img(self):
        ...
        if image_path == "":
            ...
            return
        current_status = "Face Detection Complete"
        self.text_area.delete(index1=0.0, index2=100.100)
        self.text_area.insert(index=0.0,
                              text=f"{current_status}\n\n{crowd_number}\n\n{max_accuracy}\n\n{crowd_status}")
        # time.sleep(1)
    ...
    def detectByCamera(self, writer):
        ...
        while True:
            ...
            if writer is not None:
                writer.write(img)
            cv2.imshow("Face Detection from Camera", img)
            key = cv2.waitKey(1)
            if key & 0xFF == ord('q'):
                break
    ...
    def enumeration_plot(self):
        ...
        plt.plot(framex, county, label="Face Count", color="green", marker='o', markerfacecolor='blue')
        plt.plot(framex, maxim, label="Max. Face Count", linestyle='dashed', color='fuchsia')
        plt.xlabel('Frames')
    ...
    def accuracy_plot(self):
        ...
        ax = plt.axes()
        ax.set_facecolor("yellow")
        plt.plot(framex, avg_acc_list, label="Avg. Confidence", color="green", marker='o',
                 markerfacecolor='blue')
        plt.plot(framex, max_avg_acc_list, label="Max. Avg. Confidence", linestyle='dashed', color='fuchsia')
        plt.xlabel('Frames')
        plt.ylabel('Avg. Confidence')
        plt.title('Avg. Confidence Plot')
        plt.legend()
        plt.show()
